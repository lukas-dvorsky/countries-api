...
export type GetCountryByCodeQuery = { __typename?: 'Query', country?: { __typename?: 'Country', awsRegion: string, capital?: string | null, code: string, name: string, currencies: Array<string>, emoji: string, emojiU: string, native: string, phone: string, phones: Array<string>, continent: { __typename?: 'Continent', code: string, name: string }, languages: Array<{ __typename?: 'Language', code: string, name: string, native: string, rtl: boolean }>, states: Array<{ __typename?: 'State', code?: string | null, name: string }>, subdivisions: Array<{ __typename?: 'Subdivision', code: string, emoji?: string | null, name: string }> } | null };
...
export type GetContinentCountriesQuery = { __typename?: 'Query', continent?: { __typename?: 'Continent', name: string, countries: Array<{ __typename?: 'Country', code: string, name: string }> } | null };
